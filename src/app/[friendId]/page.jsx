...
import { MdDeleteOutline, MdOutlinePhoneInTalk, MdOutlineTextsms, MdTextsms } from "react-icons/md";
    ...
    <div className="max-w-277.5 mx-auto flex flex-col md:flex-row items-center gap-5 mt-20 bg-[#F8FAFC] p-4">
      ...
      <div>
        ...
        <div className="rounded-lg shadow-xl border-2 border-gray-300 p-6 mt-6">
          <h1 className="text-[#244D3F] font-medium text-2xl">
            Quick Check-In
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <button className="btn flex flex-col h-full bg-[#E9E9E9] rounded-lg flex-1 shadow-xl p-8 cursor-pointer">
